...
import ar.edu.um.repository.BookRepository;
import ar.edu.um.service.BookService;
import ar.edu.um.service.criteria.BookCriteria;
import ar.edu.um.service.dto.BookDTO;
import ar.edu.um.service.mapper.BookMapper;
...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().isbn(DEFAULT_ISBN).name(DEFAULT_NAME).publishYear(DEFAULT_PUBLISH_YEAR).copies(DEFAULT_COPIES);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().isbn(UPDATED_ISBN).name(UPDATED_NAME).publishYear(UPDATED_PUBLISH_YEAR).copies(UPDATED_COPIES);
        return book;
    }
    ...
    void putExistingBook() throws Exception {
        ...
        updatedBook.isbn(UPDATED_ISBN).name(UPDATED_NAME).publishYear(UPDATED_PUBLISH_YEAR).copies(UPDATED_COPIES);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.isbn(UPDATED_ISBN).name(UPDATED_NAME).publishYear(UPDATED_PUBLISH_YEAR).copies(UPDATED_COPIES);
