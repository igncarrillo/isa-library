...
import ar.edu.um.repository.PublisherRepository;
import ar.edu.um.service.PublisherQueryService;
import ar.edu.um.service.PublisherService;
import ar.edu.um.service.criteria.PublisherCriteria;
import ar.edu.um.service.dto.PublisherDTO;
...
/**
 * REST controller for managing {@link ar.edu.um.domain.Publisher}.
 */
@RestController
@RequestMapping("/api")
