...
/**
 * Criteria class for the {@link ar.edu.um.domain.Book} entity. This class is used
 * in {@link ar.edu.um.web.rest.BookResource} to receive all the possible filtering options from
...
public class BookCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, isbn, name, publishYear, copies, authorId, distinct);
    }
