...
/**
 * Criteria class for the {@link ar.edu.um.domain.BorrowedBook} entity. This class is used
 * in {@link ar.edu.um.web.rest.BorrowedBookResource} to receive all the possible filtering options from
